 ...
 * @author MarcF
 */
public class CommitKohsuke implements Commit {
  
  private final GHPullRequestCommitDetail.Commit commit;
  
  public CommitKohsuke(GHPullRequestCommitDetail.Commit commit) {
    this.commit = commit;
  }
